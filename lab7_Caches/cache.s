...
accessWords:
	la	s0, array		# ptr to array, load the address of the array into s0
	add	s1, s0, a0		# hardcode array limit (ptr), the end of the array
	slli	t1, a1, 2		# multiply stepsize by 4 because WORDS, a1*4
wordLoop:
	beq	a3, zero,  wordZero # option==0
...
wordCheck:
	...
	addi	a2, a2, -1 # decrement the rest count
